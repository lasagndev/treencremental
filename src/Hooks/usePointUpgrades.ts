...
import {
    ...
    pUp117,
    pUp118,
    pUp119, pUp120, pUp121, pUp122, pUp123, pUp124, pUp125, pUp126, pUp127, pUp128, pUp129, pUp130,
    pUp201,
    pUp202,
    pUp203,
    pUp204,
...
export function usePointUpgrades(game: Game) {
    ...
    function resetUpgrades() {
        ...
        setBuyableUpgrades(prev =>
            prev.map(u => {
                if (u.id >= 301) return u;

                const defaultUpgrade = defaultPointBuyable.find(d => d.id === u.id)!;
                return {
                    ...defaultUpgrade,
